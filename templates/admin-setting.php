                ...
                <div class="postbox fp_setting_sortable" id="<?= $fieldKey ?>" style="padding:20px">
                    ...
                    <div class="container">
                        ...
                        <label
                                ...
                                $prefix . $fieldArray["admin_key"], $prefix . $fieldArray["admin_key"],
                                isset($options[$prefix . $fieldArray["admin_key"]]) ? $options[$prefix . $fieldArray["admin_key"]] == 1 ? 'checked="checked"' : '' : ''
                            ) ?>
                        </label>
                    </div>
                </div>
